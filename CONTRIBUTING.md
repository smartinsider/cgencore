Contributing to CGEN Core
============================

The CGEN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CGEN Core project, and is not to be
confused with overall CGEN Network Protocol consensus changes.

Whether a pull request is merged into CGEN Core rests with the project merge
...
Patches that change CGEN consensus rules are considerably more involved than
...
Where a patch set proposes to change the CGEN consensus, it must have been
...
The project leader is the release manager for each CGEN Core release.
