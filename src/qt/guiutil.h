...
/** Utility functions used by the CGEN Qt UI.
 */
namespace GUIUtil
{
...
// Render CGEN addresses in monospace font
...
// Parse "cgencore:" URI into recipient object, return true on successful parsing
