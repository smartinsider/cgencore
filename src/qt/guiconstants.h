...
/* CGENcore GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CGEN"
#define QAPP_ORG_DOMAIN "cgencore.io"
#define QAPP_APP_NAME_DEFAULT "CGEN-Qt"
#define QAPP_APP_NAME_TESTNET "CGEN-Qt-testnet"
