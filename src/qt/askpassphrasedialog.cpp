                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zCGEN || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending CGEN because you wouldn't check it anyway.
    if (context == Context::Send_CGEN || context == Context::Send_zCGEN) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR CGEN</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("CGEN will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your CGENs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
