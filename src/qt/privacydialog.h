...
public:
    ...
    void setZCGENcoreControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCGEN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCGEN_clicked();
    void on_pushButtonZCGENcoreControl_clicked();
