...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CGENcore Core cgencore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cgencore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cgencore transaction") + "\n" +
                               "  cgencore-tx [options] -create [commands]   " + _("Create hex-encoded cgencore transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cgencore transaction
