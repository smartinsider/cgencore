...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CGEN features */
        {"cgencore", "masternode", &masternode, true, true, false},
        {"cgencore", "listmasternodes", &listmasternodes, true, true, false},
        {"cgencore", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cgencore", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cgencore", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cgencore", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cgencore", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cgencore", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cgencore", "masternodedebug", &masternodedebug, true, true, false},
        {"cgencore", "startmasternode", &startmasternode, true, true, false},
        {"cgencore", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cgencore", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cgencore", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cgencore", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cgencore", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cgencore", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cgencore", "mnbudget", &mnbudget, true, true, false},
        {"cgencore", "preparebudget", &preparebudget, true, true, false},
        {"cgencore", "submitbudget", &submitbudget, true, true, false},
        {"cgencore", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cgencore", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cgencore", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cgencore", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cgencore", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cgencore", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cgencore", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cgencore", "checkbudgets", &checkbudgets, true, true, false},
        {"cgencore", "mnsync", &mnsync, true, true, false},
        {"cgencore", "spork", &spork, true, true, false},
        {"cgencore", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cgencore-cli " + methodname + " " + args + "\n";
}
