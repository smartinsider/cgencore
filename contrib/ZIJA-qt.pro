...
RESOURCES += src/qt/cgencore.qrc src/qt/cgencore_locale.qrc

TRANSLATIONS += src/qt/locale/cgencore_bg.ts \
                src/qt/locale/cgencore_de.ts \
                src/qt/locale/cgencore_en.ts \
                src/qt/locale/cgencore_es.ts \
                src/qt/locale/cgencore_fi.ts \
                src/qt/locale/cgencore_fr.ts \
                src/qt/locale/cgencore_it.ts \
                src/qt/locale/cgencore_ja.ts \
                src/qt/locale/cgencore_pl.ts \
                src/qt/locale/cgencore_pt.ts \
                src/qt/locale/cgencore_ru.ts \
                src/qt/locale/cgencore_sk.ts \
                src/qt/locale/cgencore_sv.ts \
                src/qt/locale/cgencore_vi.ts \
                src/qt/locale/cgencore_zh_CN.ts \
                src/qt/locale/cgencore_zh_TW.ts
