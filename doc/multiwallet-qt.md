...
In order to support loading of multiple wallets in cgencore-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cgencore.cpp.
...
Changes to cgencore.cpp
----------------------
cgencore.cpp is the entry point into cgencore-qt, and as such, will require some minor modifications to provide hooks for
